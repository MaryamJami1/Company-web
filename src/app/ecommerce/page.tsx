...
export const metadata = {
  title: "E-commerce Solutions & Marketplace Scaling | Ideas Assemble",
...
export default function EcommercePage() {
  return (
    <ServicePageLayout
      ...
      description2="Our team combines data-driven marketing with operational excellence to ensure your brand doesn't just exist online—it dominates its category across every major platform."
      highlights={[
