            ...
            <div className="bg-black rounded-[2rem] border border-white/10 shadow-2xl p-8 md:p-16 space-y-12">
              ...
              <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
                ...
                <p className="font-[var(--font-montserrat)] text-gray-600 leading-relaxed">
                  By accessing and using the services of Topstier, you agree to be bound by these Terms of Service and all applicable laws and regulations. If you do not agree with any of these terms, you are prohibited from using or accessing our site.
                </p>
              </motion.div>
              ...
              <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
                ...
                <p className="font-[var(--font-montserrat)] text-gray-600 leading-relaxed mb-4">
                  Topstier provides high-end design, branding, and digital marketing services. While we strive for perfection in every project:
                </p>
              ...
              <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
                ...
                <p className="font-[var(--font-montserrat)] text-gray-600 leading-relaxed">
                  Upon completion of the project and receipt of full payment, the client will hold full ownership of the final design deliverables. Topstier reserves the right to showcase the completed work in our portfolio for promotional purposes unless otherwise agreed in writing.
                </p>
              </motion.div>

              <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
                <div className="flex items-center gap-4 mb-6">
                  <div className="p-3 rounded-xl bg-black text-gray-600">
              ...
              <div className="pt-12 border-t border-white/10 text-center">
                <p className="font-[var(--font-montserrat)] text-sm text-gray-400">
                  Usage of our services constitutes acceptance of these terms. For enterprise contracts, please contact <span className="text-white font-bold">support@topstier.co</span>
                </p>
              </div>
