          ...
          >
            ...
            <div className="w-full max-w-3xl px-6 py-24 md:py-12 text-center relative z-10 flex flex-col items-center justify-center min-h-full">
              ...
              {step === 6 && (
                ...
                >
                  <div className="w-20 h-20 md:w-24 md:h-24 bg-[var(--color-arc-blue)]/20 border-2 border-[var(--color-arc-blue)] rounded-full flex items-center justify-center mx-auto mb-6 md:mb-8 shadow-[0_0_30px_rgba(0,210,255,0.3)]">
                    <CheckCircle2 className="w-10 h-10 md:w-12 md:h-12 text-[var(--color-arc-blue)]" />
                  </div>
                  <h3 className="text-3xl md:text-4xl font-[var(--font-orbitron)] font-black text-white mb-4 md:mb-6 uppercase tracking-wider">
                    Details Received!
                  </h3>
                  <p className="text-base md:text-lg text-gray-400 font-[var(--font-montserrat)] mb-8 md:mb-10 max-w-xl mx-auto leading-relaxed px-4">
                    We've received your logo requirements. Our team is reviewing the details and will contact you shortly with the next steps.
                  </p>
                  <button
                    onClick={() => setIsOpen(false)}
                    className="bg-white text-black px-8 py-3.5 md:px-10 md:py-4 rounded-full font-[var(--font-orbitron)] text-xs md:text-sm font-bold uppercase tracking-widest hover:bg-gray-200 transition-all"
                  >
                    Return to Homepage
                  </button>
                </motion.div>
